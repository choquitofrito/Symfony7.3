...
class IngredientController extends AbstractController
{
    ...
    public function searchIngredient(ManagerRegistry $doctrine, Request $req, SerializerInterface $serializer): Response
    {
        ...
        if (is_null($req->get('texte'))) {
            ...
            $ingredients = $doctrine->getManager()->getRepository(Ingredient::class)->createQueryBuilder('i')
            ...
            if (count($ingredients) > 0) {
                ...
                $IngredientJson = $serializer->serialize($ingredients, 'json', 
