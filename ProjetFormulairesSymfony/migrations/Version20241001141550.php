 ...
 */
final class Version20241001141550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, images JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, prix NUMERIC(10, 2) DEFAULT NULL, description LONGTEXT DEFAULT NULL, date_publication DATE DEFAULT NULL, nombre_pages INT DEFAULT NULL, date_edition DATE DEFAULT NULL, format VARCHAR(255) DEFAULT NULL, langue VARCHAR(255) DEFAULT NULL, INDEX IDX_AC634F994296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
