...
class ExemplesAjaxAxiosController extends AbstractController
{
    ...
    public function exempleAffichageObjetsTraitementRepo(ManagerRegistry $doctrine, Request $req, SerializerInterface $serializer)
    {
        ...
        $aeroports = $serializer->serialize($aeroports, 'json');
