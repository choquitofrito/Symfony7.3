...
class ExemplesFormulairesController extends AbstractController
{
    ...
    // Example de POST. Attention, on obtient les valeurs avec $req->request: 
    // Ex: $nom = $req->request->get('nom')
    ...
    #[Route("/insert/livre/traitement", name: "traitement_insert_livre")]
    public function insertLivreTraitement()
    {
        dd ("ici on doit traiter le formulaire");
    }
}
